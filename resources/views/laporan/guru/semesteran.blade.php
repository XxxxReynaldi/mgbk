...
<div class="container">
    ...
    <div class="columns is-multiline is-mobile">        
        <div class="column is-half">
            <h1 class="title is-5 mb-2">Semesteran </h1>
            <p class="control">
        ...
        <div class="column is-half is-vcentered">
            <div class="field is-grouped is-grouped-right">
                <p class="control">
                    <form action="{{ route('user.laporan.print.semester') }}" method="post" id="print-form">
                        @csrf
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#table-laporan').DataTable({
            ...
            order: [[1, 'desc']],
            ajax: {
            url         : '{!! route('user.laporan.tb-semesteran') !!}',
