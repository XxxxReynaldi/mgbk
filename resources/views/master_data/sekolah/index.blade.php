            ...
            <section class="modal-card-body">
                ...
                <div class="field">
                    ...
                    <p class="control has-icons-left has-icons-right">
                      <input name="nama_sekolah" id="namaSekolah" class="input" type="text" placeholder="Nama Sekolah">
          ...
          <form method="post" action="" id="editForm">
            <section class="modal-card-body">
                ...
                <div class="field">
                    ...
                    <p class="control has-icons-left has-icons-right">
                      <input value="" name="nama_sekolah" id="nama_sekolah" class="input" type="text" placeholder="Nama Sekolah">
                      <span class="icon is-small is-left">
                        <i class="fas fa-school"></i>
                      </span>
                    </p>
